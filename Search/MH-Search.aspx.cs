...
namespace Search
{
    public partial class MH_Search : System.Web.UI.Page
    {
        // *** Connection String *** //
        ...
        protected void btn_Click(object sender, EventArgs e)
        {
            ...
            switch (btn)
            {
                ...
                case "btnSearchAddress":
                    ...
                    {
                        lblSearchAddressWarning.Text = "STREET NUMBER must be numeric";
                        lblSearchAddressWarning.Visible = true;
                        gvSearchAddress.Visible = false;
                    }
                    else
        ...
        private void PopulateGridView_owner()
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("InfoListByOwnerMH_cama", con);
        ...
        private void PopulateGridView_address()
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("Infolistbysitusmh_cama", con);
                ...
                cmd.Parameters.Add("@OrderByType", SqlDbType.VarChar).Value = "";
        ...
        private void PopulateGridView_parcel()
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("Infolistbyparcelmh_cama", con);
        ...
        private void PopulateGridView_TaxID()
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("Infolistbytaxpayeridmh_cama", con);
        ...
        protected void gv_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string Location = ResolveUrl("~/MH-Details.aspx") + "?id=" + LeadID;
