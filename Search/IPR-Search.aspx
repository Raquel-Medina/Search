<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IPR-Search.aspx.cs" Inherits="Search.IPR_Search" MaintainScrollPositionOnPostback="true" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Pinal County Assessor Improvements on Possessory Rights Search</title>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
    ...
    <div class="search-page">
        <div class="container">
            <div class="header-banner">
                ...
                <h2 class="header-title mb-5">Improvements on Possessory<br />
                    Rights (IPR) Search
                </h2>
            </div>
            <form runat="server">
                ...
                <div id="searchName" runat="server" visible="false">
                    ...
                    <div class="row">
                        <div class="col-lg-10 col-sm-12 align-self-center pb-2">
                            <asp:TextBox ID="txtOwner" CssClass="form-control" placeholder="LAST/FIRST" runat="server" />
                        </div>
