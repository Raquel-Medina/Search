...
namespace Search
{
    public partial class FoodInspection_Details : System.Web.UI.Page
    {
        // *** Connection String *** //
        ...
        protected void GetItemDetails()
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                while (dr.Read())
                {
                    ...
                    if (int.Parse(itemDisplayOrder) < 60)
                    {
                        if (itemStatus == "Not Applicable")
                        {
                            lbl.Text = "N/A";
                        }
                        else if (itemStatus == "Not Observed")
                        {
                            lbl.Text = "N/O";
                        }
                        else if (itemStatus == "Corrected")
                        {
                            lbl.Text = "Out";
                        }
                        else if (itemStatus == "Yes")
                        {
                            lbl.Text = "In";
                        }
                        else if (itemStatus == "No")
                        {
                            lbl.Text = "Out";
                        }
                        else if (itemStatus == "Out - Major")
                        {
                            lbl.Text = "Out";
                        }
                        else if (itemStatus == "Corrected - Major")
                        {
                            lbl.Text = "Out";
                        }
                        else
        ...
        {
            Response.Redirect("FoodInspection-Search.aspx");
        }
    }
}