<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IPR-Details.aspx.cs" Inherits="Search.IPR_Details" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>IPR Details</title>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
    ...
    <div class="details-page">
        <div class="container">
            <div class="header-banner">
                ...
                <h2 class="header-title">Improvements on Possessory<br />
                    Rights (IPR) Search
                </h2>
            </div>
            <form id="form1" runat="server">
                ...
                <div class="content">
                    <h5 class="header-title">IPR Details</h5>
                    ...
                    <div class="details-section">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-12 pb-2">
                                ...
                                <div class="detail"><asp:Label ID="lblFCVAssessed" runat="server" /></div>
                            </div>
                            <div class="col-lg-4 col-sm-12 pb-2">
                                <div class="details-title">ASSESSED LPV</div>
                                <div class="detail"><asp:Label ID="lblLPVAssessed" runat="server" /></div>
                            </div>
                        </div>
                    </div>
                    <!-- Disclaimer -->
